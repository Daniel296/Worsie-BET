                ...
                <div class="line-input">
                    <div class="form-register">
                        <div class="left-form">
							...
							<input type="password" id="reg_password" onchange="validate_register_data(4)" required/>
                        </div>
                        <div class="right-form">
                ...
                <div class="line-input">
                    <div class="form-register">
                        ...
                        <div class="right-form">
        				    ...
        				    <input type="text" value="Romania" id="country" onchange="validate_register_data(11)" required/>
                        </div>
        			</div>
                </div>
                ...
                <div class="line-input">
                    <div class="form-register">
                        <div class="left-form">
						 ...
						 ?> onchange="validate_register_data(13)" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" required >
            			</div>
                        <div class="right-form">
